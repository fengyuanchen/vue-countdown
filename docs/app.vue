      ...
      <nav class="container">
        ...
        >
          <nav class="nav navbar-nav">
            <a
              class="nav-link"
              href="https://github.com/fengyuanchen/vue-countdown"
    ...
    <footer>
      <div class="container">
        ...
        <nav class="nav flex-wrap justify-content-center mb-3">
          ...
          <a
            class="nav-link"
            href="https://github.com/fengyuanchen/vue-countdown/blob/main/CHANGELOG.md"
          >
            Changelog
          </a>
          <a
            class="nav-link"
            href="https://github.com/fengyuanchen/vue-countdown/blob/main/LICENSE"
          >
            License
          </a>
          <a
